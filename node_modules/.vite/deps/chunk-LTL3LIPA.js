...
import {
  ...
  NH,
  bH
} from "./chunk-KDWFICUU.js";

// node_modules/@iamjariwala/react-doc-viewer/dist/index-C20ElpRl.js
function un(e2, t) {
...
var Ot = {};
(function(e2) {
  e2.fetch = i(Ga.fetch) && i(Ga.ReadableStream), e2.writableStream = i(Ga.WritableStream), e2.abortController = i(Ga.AbortController);
  var t;
  function r() {
    if (t !== void 0)
      return t;
    if (Ga.XMLHttpRequest) {
      t = new Ga.XMLHttpRequest();
      try {
        t.open("GET", Ga.XDomainRequest ? "/" : "https://example.com");
      } catch {
        t = null;
      }
    } else
...
var at = Bi;
var Fi = typeof globalThis > "u" ? Ga : globalThis;
var Ui = function() {
...
var Hr = jt();
var er = typeof globalThis > "u" ? Ga : globalThis;
var At = ki();
...
(function(e2) {
  ...
  e2.format = function(d) {
    ...
    if (typeof Jd < "u" && Jd.noDeprecation === true)
      return d;
    if (typeof Jd > "u")
      return function() {
    ...
    function D() {
      if (!_) {
        if (Jd.throwDeprecation)
          throw new Error(g);
        Jd.traceDeprecation ? console.trace(g) : console.error(g), _ = true;
      }
  ...
  var n = {}, i = /^$/;
  if (Jd.env.NODE_DEBUG) {
    var c = Jd.env.NODE_DEBUG;
 ...
 `) + " " + d.join(`,
  ...
  function ue(d) {
    ...
    function g() {
      ...
      d.apply(this, _).then(
        function(w) {
          Jd.nextTick(y.bind(null, null, w));
        },
        function(w) {
          Jd.nextTick(ne.bind(null, w, y));
        }
      );
    }
...
function Ki(e2, t) {
  ...
  return n || i ? (t ? t(e2) : e2 && (this._writableState ? this._writableState.errorEmitted || (this._writableState.errorEmitted = true, Jd.nextTick(Rt, this, e2)) : Jd.nextTick(Rt, this, e2)), this) : (this._readableState && (this._readableState.destroyed = true), this._writableState && (this._writableState.destroyed = true), this._destroy(e2 || null, function(c) {
    !t && c ? r._writableState ? r._writableState.errorEmitted ? Jd.nextTick(Ue, r) : (r._writableState.errorEmitted = true, Jd.nextTick(rr, r, c)) : Jd.nextTick(rr, r, c) : t ? (Jd.nextTick(Ue, r), t(c)) : Jd.nextTick(Ue, r);
  }), this);
}
function rr(e2, t) {
  Rt(e2, t), Ue(e2);
...
function Yr() {
  ...
  var r = {
    deprecate: io
  }, n = Mr, i = Ge.Buffer, c = (typeof Ga < "u" ? Ga : typeof window < "u" ? window : typeof self < "u" ? self : {}).Uint8Array || function() {
  };
  function l(u) {
    return i.from(u);
  }
  ...
  function I(u, f) {
    var y = new m();
    R(u, y), Jd.nextTick(f, y);
  }
  function K(u, f, y, w) {
    var j;
    return y === null ? j = new s() : typeof y != "string" && !f.objectMode && (j = new N("chunk", ["string", "Buffer"], y)), j ? (R(u, j), Jd.nextTick(w, j), false) : true;
  }
  ...
  function Q(u, f, y, w, j) {
    --f.pendingcb, y ? (Jd.nextTick(j, w), Jd.nextTick(g, u, f), u._writableState.errorEmitted = true, R(u, w)) : (j(w), u._writableState.errorEmitted = true, R(u, w), g(u, f));
  }
  function oe(u) {
  ...
  function ae(u, f) {
    ...
    if (oe(y), f)
      ...
      !o && !y.corked && !y.bufferProcessing && y.bufferedRequest && Y(u, y), w ? Jd.nextTick(te, u, y, o, j) : te(u, y, o, j);
    }
  }
  function te(u, f, y, w) {
  ...
  function d(u, f) {
    !f.prefinished && !f.finalCalled && (typeof u._final == "function" && !f.destroyed ? (f.pendingcb++, f.finalCalled = true, Jd.nextTick(ue, u, f)) : (f.prefinished = true, u.emit("prefinish")));
  }
  function g(u, f) {
    var y = ne(f);
  ...
  function _(u, f, y) {
    f.ending = true, g(u, f), y && (f.finished ? Jd.nextTick(y) : u.once("finish", y)), f.ended = true, u.writable = false;
  }
  function D(u, f, y) {
    var w = u.entry;
    for (u.entry = null; w; ) {
...
function Re() {
  ...
  function h() {
    this._writableState.ended || Jd.nextTick(p, this);
  }
  function p(A) {
    A.end();
  }
...
function Xr() {
  ...
  }, r = Mr, n = Ge.Buffer, i = (typeof Ga < "u" ? Ga : typeof window < "u" ? window : typeof self < "u" ? self : {}).Uint8Array || function() {
  };
  function c(o) {
    return n.from(o);
  }
  ...
  function te(o) {
    ...
    p("emitReadable", a.needReadable, a.emittedReadable), a.needReadable = false, a.emittedReadable || (p("emitReadable", a.flowing), a.emittedReadable = true, Jd.nextTick(re, o));
  }
  function re(o) {
    var a = o._readableState;
  ...
  function Y(o, a) {
    a.readingMore || (a.readingMore = true, Jd.nextTick(ne, o, a));
  }
  function ne(o, a) {
  ...
  I.prototype._read = function(o) {
    ...
    var G = (!a || a.end !== false) && o !== Jd.stdout && o !== Jd.stderr, k = G ? se : Te;
    T.endEmitted ? Jd.nextTick(k) : b.once("end", k), o.on("unpipe", x);
    function x(ge, ve) {
  ...
  I.prototype.unpipe = function(o) {
    ...
    return o === "data" ? (T.readableListening = this.listenerCount("readable") > 0, T.flowing !== false && this.resume()) : o === "readable" && !T.endEmitted && !T.readableListening && (T.readableListening = T.needReadable = true, T.flowing = false, T.emittedReadable = false, p("on readable", T.length, T.reading), T.length ? te(this) : T.reading || Jd.nextTick(g, this)), b;
  ...
  function _(o, a) {
    a.resumeScheduled || (a.resumeScheduled = true, Jd.nextTick(D, o, a));
  }
  function D(o, a) {
  ...
  function y(o) {
    var a = o._readableState;
    p("endReadable", a.endEmitted), a.endEmitted || (a.ended = true, Jd.nextTick(w, a, o));
  }
  function w(o, a) {
      ...
      var c = new WritableStream({
        write: function(E) {
          return n(false), new Promise(function(N, W) {
            i._destroyed ? W() : i.push(Le.from(E)) ? N() : i._resumeFetch = N;
          });
        },
        close: function() {
  ...
  switch (t._mode) {
    case "text":
      if (n = r.responseText, n.length > t._pos) {
        ...
        if (t._charset === "x-user-defined") {
          for (var c = Le.alloc(i.length), l = 0; l < i.length; l++)
    ...
    case "arraybuffer":
      if (r.readyState !== Ce.DONE || !r.response)
        break;
      n = r.response, t.push(Le.from(new Uint8Array(n)));
      break;
    case "moz-chunked-arraybuffer":
      if (n = r.response, r.readyState !== Ce.LOADING || !n)
        break;
      t.push(Le.from(new Uint8Array(n)));
      break;
    case "ms-stream":
      if (n = r.response, r.readyState !== Ce.LOADING)
        break;
      var h = new Ga.MSStreamReader();
      h.onprogress = function() {
        h.result.byteLength > t._pos && (t.push(Le.from(new Uint8Array(h.result.slice(t._pos)))), t._pos = h.result.byteLength);
      }, h.onload = function() {
        e2(true), t.push(null);
...
var J = mr.exports = function(e2) {
  var t = this;
  Ut.Writable.call(t), t._opts = e2, t._body = [], t._headers = {}, e2.auth && t.setHeader("Authorization", "Basic " + Le.from(e2.auth).toString("base64")), Object.keys(e2.headers).forEach(function(i) {
  ...
  if (!e2._destroyed) {
    ...
    if (Object.keys(r).forEach(function(p) {
      ...
      if (de.abortController) {
        ...
        c = l.signal, e2._fetchAbortController = l, "requestTimeout" in t && t.requestTimeout !== 0 && (e2._fetchTimer = Ga.setTimeout(function() {
          e2.emit("requestTimeout"), e2._fetchAbortController && e2._fetchAbortController.abort();
        }, t.requestTimeout));
      }
      Ga.fetch(e2._opts.url, {
      ...
      var h = e2._xhr = new Ga.XMLHttpRequest();
      try {
...
J.prototype._resetTimers = function(e2) {
  var t = this;
  Ga.clearTimeout(t._socketTimer), t._socketTimer = null, e2 ? (Ga.clearTimeout(t._fetchTimer), t._fetchTimer = null) : t._socketTimeout && (t._socketTimer = Ga.setTimeout(function() {
    t.emit("timeout");
  }, t._socketTimeout));
};
...
(function(e2) {
  ...
  l.request = function(h, p) {
    ...
    var A = Ga.location.protocol.search(/^https?:$/) === -1 ? "http:" : "", L = h.protocol || A, E = h.hostname || h.host, N = h.port, W = h.path || "/";
...
//# sourceMappingURL=chunk-LTL3LIPA.js.map
